"""
Main Script: Run Hybrid NTL Detection System
Orchestrates the complete pipeline: Data → ML → Physics → Fusion → Results
"""
...
class HybridNTLDetectionPipeline:
    """
    Complete Hybrid NTL Detection Pipeline
    Combines ML and Physics-based approaches
    """
    ...
    def run_pipeline(
        ...
        Args:
            mode: Pipeline mode - "full", "ml_only", "physics_only", "evaluation"
        ...
        try:
            ...
            if mode in ["full", "physics_only", "evaluation"]:
                ...
                # Step 6: Physics-based Localization
                logger.info("\n" + "="*80)
            ...
            if mode == "full":
                ...
                # Evaluation mode: compare both approaches
                logger.info("\n" + "="*80)
    ...
    def _load_data(self, start_date: Optional[str], end_date: Optional[str]):
        """Load consumption and grid data"""
        data_config = self.config['data']
        
        # Load smart meter consumption data
        ...
        # Load historical visits (if available)
    ...
    def _train_ml_model(self):
        ...
        # Target: energy recovered (from visit data)
        if self.results['visits_data'] is not None:
            # Merge with visits to get target
    ...
    def _detect_anomalies(self) -> pd.DataFrame:
        ...
        if self.results['transformer_data'] is not None:
            ...
            # Estimate technical losses (simplified: 2% of transformer power)
        ...
        # 2. Consumption pattern anomalies
    ...
    def _run_physics_localization(
        ...
        """Run physics-based localization"""
        ...
        # Select meters to investigate
        logger.info(f"Using approach: {localization_config.approach}")
        
        # Get first timestamp for analysis
    ...
    def _fuse_predictions(
        ...
        """Fuse ML and Physics predictions"""
    ...
    def _evaluate_models(
        ...
        """Evaluate and compare ML vs Physics approaches"""
        logger.info("Evaluating model performance...")
        
        # This requires ground truth labels
        # For demonstration, we'll use simulated ground truth
